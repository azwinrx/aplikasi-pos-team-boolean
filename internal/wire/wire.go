...
func setupRoutes(router *gin.Engine, authHandler *adaptor.AuthAdaptor, inventoriesHandler *adaptor.InventoriesAdaptor, staffHandler *adaptor.StaffAdaptor, orderHandler *adaptor.OrderAdaptor, revenueHandler *adaptor.RevenueAdaptor, reservationHandler *adaptor.ReservationsAdaptor, logger *zap.Logger) {
	// Health check
